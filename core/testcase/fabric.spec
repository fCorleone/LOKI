<LOKI specname="fabric:example">
	...
	<Message name="Prepare">
		...
		<Attribute name="Assist" type=Bool mutation="random_bool" />
 		<ExceptedMsg mag_name="Commit" identify="View,Seq" msg_identify="Commit.View,Commit.Seq" />
	</Message>
	...
	<Message name="Commit">
		<Attribute name="some_att" type=Enum ref="enum1"/>
	</Message>

	<Enum name="enum1">
		<Attribute name="View" type=Number size="64" mutation="random_number"/>
		<Attribute name="Seq" type=String mutation="random_number" />
		<Attribute name="Submsg" type=Struct ref="Other_msg" />
	</Enum>
