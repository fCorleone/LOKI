...
pub trait Loki_protoVisitor<'input>: ParseTreeVisitor<'input, Loki_protoParserContextType> {
     ...
     */
    fn visit_proto(&mut self, ctx: &ProtoContext<'input>) {
     ...
     * @param ctx the parse tree
     */
    fn visit_syntax(&mut self, ctx: &SyntaxContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_packageStatement(&mut self, ctx: &PackageStatementContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_topLevelDef(&mut self, ctx: &TopLevelDefContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_messageBody(&mut self, ctx: &MessageBodyContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_enumField(&mut self, ctx: &EnumFieldContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_enumValueOption(&mut self, ctx: &EnumValueOptionContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_service(&mut self, ctx: &ServiceContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_rpc(&mut self, ctx: &RpcContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_reserved(&mut self, ctx: &ReservedContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_ranges(&mut self, ctx: &RangesContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_fieldNames(&mut self, ctx: &FieldNamesContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_eleType(&mut self, ctx: &EleTypeContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_fieldNumber(&mut self, ctx: &FieldNumberContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_fieldOptions(&mut self, ctx: &FieldOptionsContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_fieldOption(&mut self, ctx: &FieldOptionContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_oneof(&mut self, ctx: &OneofContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_oneofField(&mut self, ctx: &OneofFieldContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_mapField(&mut self, ctx: &MapFieldContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_keyType(&mut self, ctx: &KeyTypeContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_fullIdent(&mut self, ctx: &FullIdentContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_messageName(&mut self, ctx: &MessageNameContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_messageOrEnumName(&mut self, ctx: &MessageOrEnumNameContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_oneofName(&mut self, ctx: &OneofNameContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_mapName(&mut self, ctx: &MapNameContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_rpcName(&mut self, ctx: &RpcNameContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_messageType(&mut self, ctx: &MessageTypeContext<'input>) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_messageOrEnumType(&mut self, ctx: &MessageOrEnumTypeContext<'input>) {
        self.visit_children(ctx)
    }
