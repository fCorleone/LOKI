...
type BaseParserType<'input, I> = BaseParser<
    ...
    Loki_protoParserExt,
    I,
    Loki_protoParserContextType,
    dyn Loki_protoListener<'input> + 'input,
>;
...
impl<'input, I>
    Loki_protoParser<'input, I, DefaultErrorStrategy<'input, Loki_protoParserContextType>>
where
    I: TokenStream<'input, TF = LocalTokenFactory<'input>> + TidAble<'input>,
{
...
impl<'input, I: TokenStream<'input, TF = LocalTokenFactory<'input>> + TidAble<'input>>
    ParserRecog<'input, BaseParserType<'input, I>> for Loki_protoParserExt
{
}

impl<'input, I: TokenStream<'input, TF = LocalTokenFactory<'input>> + TidAble<'input>>
    Actions<'input, BaseParserType<'input, I>> for Loki_protoParserExt
{
...
impl<'input> ProtoContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<ProtoContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            ProtoContextExt { ph: PhantomData },
        ))
    }
}

pub trait ProtoContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<ProtoContextExt<'input>>
{
    fn syntax(&self) -> Option<Rc<SyntaxContextAll<'input>>>
    where
        Self: Sized,
    {
    ...
    fn EOF(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(EOF, 0)
    }
    fn importStatement_all(&self) -> Vec<Rc<ImportStatementContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn importStatement(&self, i: usize) -> Option<Rc<ImportStatementContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
    }
    fn packageStatement_all(&self) -> Vec<Rc<PackageStatementContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn packageStatement(&self, i: usize) -> Option<Rc<PackageStatementContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
    ...
    fn topLevelDef_all(&self) -> Vec<Rc<TopLevelDefContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn topLevelDef(&self, i: usize) -> Option<Rc<TopLevelDefContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
    }
    fn emptyStatement_all(&self) -> Vec<Rc<EmptyStatementContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn emptyStatement(&self, i: usize) -> Option<Rc<EmptyStatementContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn proto(&mut self) -> Result<Rc<ProtoContextAll<'input>>, ANTLRError> {
        let mut recog = self;
...
impl<'input> SyntaxContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<SyntaxContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            SyntaxContextExt { ph: PhantomData },
        ))
    }
}

pub trait SyntaxContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<SyntaxContextExt<'input>>
{
    ...
    fn SYNTAX(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn ASSIGN(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn SEMI(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn PROTO3_DOUBLE(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn PROTO3_SINGLE(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn syntax(&mut self) -> Result<Rc<SyntaxContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
pub type ImportStatementContext<'input> =
    BaseParserRuleContext<'input, ImportStatementContextExt<'input>>;
...
impl<'input, 'a> Listenable<dyn Loki_protoListener<'input> + 'a>
    for ImportStatementContext<'input>
{
    fn enter(&self, listener: &mut (dyn Loki_protoListener<'input> + 'a)) {
        listener.enter_every_rule(self);
...
impl<'input> ImportStatementContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<ImportStatementContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            ImportStatementContextExt { ph: PhantomData },
        ))
    }
}

pub trait ImportStatementContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<ImportStatementContextExt<'input>>
{
    ...
    fn IMPORT(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn StrLit(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn WEAK(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn PUBLIC(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn importStatement(&mut self) -> Result<Rc<ImportStatementContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx =
            ImportStatementContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 4, RULE_importStatement);
...
pub type PackageStatementContext<'input> =
    BaseParserRuleContext<'input, PackageStatementContextExt<'input>>;
...
impl<'input, 'a> Listenable<dyn Loki_protoListener<'input> + 'a>
    for PackageStatementContext<'input>
{
    fn enter(&self, listener: &mut (dyn Loki_protoListener<'input> + 'a)) {
        listener.enter_every_rule(self);
...
impl<'input> PackageStatementContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<PackageStatementContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            PackageStatementContextExt { ph: PhantomData },
        ))
    }
}

pub trait PackageStatementContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<PackageStatementContextExt<'input>>
{
    ...
    fn PACKAGE(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(PACKAGE, 0)
    }
    fn fullIdent(&self) -> Option<Rc<FullIdentContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn packageStatement(
        &mut self,
    ) -> Result<Rc<PackageStatementContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx =
            PackageStatementContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 6, RULE_packageStatement);
...
pub trait OptionContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<OptionContextExt<'input>>
{
    ...
    fn OPTION(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(OPTION, 0)
    }
    fn optionName(&self) -> Option<Rc<OptionNameContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
impl<'input> OptionNameContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<OptionNameContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            OptionNameContextExt { ph: PhantomData },
        ))
    }
}

pub trait OptionNameContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<OptionNameContextExt<'input>>
{
    /// Retrieves all `TerminalNode`s corresponding to token Ident in current rule
    fn Ident_all(&self) -> Vec<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    ...
    fn Ident(&self, i: usize) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn LPAREN(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn RPAREN(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn DOT_all(&self) -> Vec<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    ...
    fn DOT(&self, i: usize) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn optionName(&mut self) -> Result<Rc<OptionNameContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = OptionNameContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 10, RULE_optionName);
...
impl<'input> TopLevelDefContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<TopLevelDefContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            TopLevelDefContextExt { ph: PhantomData },
        ))
    }
}

pub trait TopLevelDefContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<TopLevelDefContextExt<'input>>
{
    fn message(&self) -> Option<Rc<MessageContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    }
    fn enumDefinition(&self) -> Option<Rc<EnumDefinitionContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    }
    fn service(&self) -> Option<Rc<ServiceContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn topLevelDef(&mut self) -> Result<Rc<TopLevelDefContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = TopLevelDefContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 12, RULE_topLevelDef);
...
pub trait MessageContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<MessageContextExt<'input>>
{
    ...
    fn MESSAGE(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(MESSAGE, 0)
    }
    fn messageName(&self) -> Option<Rc<MessageNameContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    }
    fn messageBody(&self) -> Option<Rc<MessageBodyContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
impl<'input> MessageBodyContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<MessageBodyContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            MessageBodyContextExt { ph: PhantomData },
        ))
    }
}

pub trait MessageBodyContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<MessageBodyContextExt<'input>>
{
    ...
    fn LBRACE(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn RBRACE(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn enumDefinition_all(&self) -> Vec<Rc<EnumDefinitionContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn enumDefinition(&self, i: usize) -> Option<Rc<EnumDefinitionContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
    ...
    fn oneof_all(&self) -> Vec<Rc<OneofContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn oneof(&self, i: usize) -> Option<Rc<OneofContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
    }
    fn mapField_all(&self) -> Vec<Rc<MapFieldContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn mapField(&self, i: usize) -> Option<Rc<MapFieldContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
    }
    fn reserved_all(&self) -> Vec<Rc<ReservedContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn reserved(&self, i: usize) -> Option<Rc<ReservedContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn messageBody(&mut self) -> Result<Rc<MessageBodyContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = MessageBodyContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 16, RULE_messageBody);
                ...
                {
                    {
                        ...
                        match recog.base.input.la(1) {
                            ...
                            | REPEATED | SFIXED32 | SFIXED64 | SINT32 | SINT64 | STRING
                            | UINT32 | UINT64 | Ident | DOT => {
                                {
                                    /*InvokeRule field*/
...
pub type EnumDefinitionContext<'input> =
    BaseParserRuleContext<'input, EnumDefinitionContextExt<'input>>;
...
impl<'input> EnumDefinitionContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<EnumDefinitionContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            EnumDefinitionContextExt { ph: PhantomData },
        ))
    }
}

pub trait EnumDefinitionContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<EnumDefinitionContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token ENUM
    /// Returns `None` if there is no child corresponding to token ENUM
    fn ENUM(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(ENUM, 0)
    }
    fn enumName(&self) -> Option<Rc<EnumNameContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    }
    fn enumBody(&self) -> Option<Rc<EnumBodyContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn enumDefinition(&mut self) -> Result<Rc<EnumDefinitionContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx =
            EnumDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 18, RULE_enumDefinition);
...
impl<'input> EnumBodyContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<EnumBodyContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            EnumBodyContextExt { ph: PhantomData },
        ))
    }
}

pub trait EnumBodyContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<EnumBodyContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token LBRACE
    /// Returns `None` if there is no child corresponding to token LBRACE
    fn LBRACE(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    ...
    fn enumField_all(&self) -> Vec<Rc<EnumFieldContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn enumField(&self, i: usize) -> Option<Rc<EnumFieldContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn enumBody(&mut self) -> Result<Rc<EnumBodyContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        ...
        let result: Result<(), ANTLRError> = try {
            ...
            recog.base.enter_outer_alt(None, 1);
            {
                ...
                while ((_la) & !0x3f) == 0
                    && ((1usize << _la)
                        & ((1usize << OPTION) | (1usize << Ident) | (1usize << SEMI)))
                        != 0
                {
                    {
...
impl<'input> EnumFieldContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<EnumFieldContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            EnumFieldContextExt { ph: PhantomData },
        ))
    }
}

pub trait EnumFieldContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<EnumFieldContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token Ident
    /// Returns `None` if there is no child corresponding to token Ident
    fn Ident(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn IntLit(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn MINUS(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn LBRACK(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(LBRACK, 0)
    }
    fn enumValueOption_all(&self) -> Vec<Rc<EnumValueOptionContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn enumValueOption(&self, i: usize) -> Option<Rc<EnumValueOptionContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
    ...
    fn RBRACK(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    ...
    fn COMMA(&self, i: usize) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn enumField(&mut self) -> Result<Rc<EnumFieldContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
pub type EnumValueOptionContext<'input> =
    BaseParserRuleContext<'input, EnumValueOptionContextExt<'input>>;
...
impl<'input, 'a> Listenable<dyn Loki_protoListener<'input> + 'a>
    for EnumValueOptionContext<'input>
{
    fn enter(&self, listener: &mut (dyn Loki_protoListener<'input> + 'a)) {
        listener.enter_every_rule(self);
...
impl<'input> EnumValueOptionContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<EnumValueOptionContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            EnumValueOptionContextExt { ph: PhantomData },
        ))
    }
}

pub trait EnumValueOptionContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<EnumValueOptionContextExt<'input>>
{
    fn optionName(&self) -> Option<Rc<OptionNameContextAll<'input>>>
    where
        Self: Sized,
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn enumValueOption(&mut self) -> Result<Rc<EnumValueOptionContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx =
            EnumValueOptionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 24, RULE_enumValueOption);
...
impl<'input> ServiceContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<ServiceContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            ServiceContextExt { ph: PhantomData },
        ))
    }
}

pub trait ServiceContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<ServiceContextExt<'input>>
{
    ...
    fn SERVICE(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(SERVICE, 0)
    }
    fn serviceName(&self) -> Option<Rc<ServiceNameContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    ...
    fn rpc_all(&self) -> Vec<Rc<RpcContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn rpc(&self, i: usize) -> Option<Rc<RpcContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn service(&mut self) -> Result<Rc<ServiceContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        ...
        let result: Result<(), ANTLRError> = try {
            ...
            recog.base.enter_outer_alt(None, 1);
            {
                ...
                _la = recog.base.input.la(1);
                while ((_la) & !0x3f) == 0
                    && ((1usize << _la) & ((1usize << OPTION) | (1usize << RPC) | (1usize << SEMI)))
                        != 0
                {
                    {
...
impl<'input> RpcContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<RpcContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            RpcContextExt { ph: PhantomData },
        ))
    }
}

pub trait RpcContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<RpcContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token RPC
    /// Returns `None` if there is no child corresponding to token RPC
    fn RPC(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(RPC, 0)
    }
    fn rpcName(&self) -> Option<Rc<RpcNameContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    ...
    fn LPAREN_all(&self) -> Vec<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    ...
    fn LPAREN(&self, i: usize) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(LPAREN, i)
    }
    fn messageType_all(&self) -> Vec<Rc<MessageTypeContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn messageType(&self, i: usize) -> Option<Rc<MessageTypeContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
    ...
    fn RPAREN_all(&self) -> Vec<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    ...
    fn RPAREN(&self, i: usize) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn RETURNS(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn STREAM_all(&self) -> Vec<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    ...
    fn STREAM(&self, i: usize) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn rpc(&mut self) -> Result<Rc<RpcContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> ReservedContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<ReservedContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            ReservedContextExt { ph: PhantomData },
        ))
    }
}

pub trait ReservedContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<ReservedContextExt<'input>>
{
    ...
    fn RESERVED(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn ranges(&self) -> Option<Rc<RangesContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    }
    fn fieldNames(&self) -> Option<Rc<FieldNamesContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn reserved(&mut self) -> Result<Rc<ReservedContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> RangesContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<RangesContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            RangesContextExt { ph: PhantomData },
        ))
    }
}

pub trait RangesContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<RangesContextExt<'input>>
{
    fn range_all(&self) -> Vec<Rc<RangeContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn range(&self, i: usize) -> Option<Rc<RangeContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn ranges(&mut self) -> Result<Rc<RangesContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> RangeContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<RangeContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            RangeContextExt { ph: PhantomData },
        ))
    }
}

pub trait RangeContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<RangeContextExt<'input>>
{
    /// Retrieves all `TerminalNode`s corresponding to token IntLit in current rule
    fn IntLit_all(&self) -> Vec<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    ...
    fn IntLit(&self, i: usize) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn TO(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(TO, 0)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn range(&mut self) -> Result<Rc<RangeContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> FieldNamesContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<FieldNamesContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            FieldNamesContextExt { ph: PhantomData },
        ))
    }
}

pub trait FieldNamesContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<FieldNamesContextExt<'input>>
{
    /// Retrieves all `TerminalNode`s corresponding to token StrLit in current rule
    fn StrLit_all(&self) -> Vec<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    ...
    fn StrLit(&self, i: usize) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn fieldNames(&mut self) -> Result<Rc<FieldNamesContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = FieldNamesContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 36, RULE_fieldNames);
...
impl<'input> EleTypeContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<EleTypeContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            EleTypeContextExt { ph: PhantomData },
        ))
    }
}

pub trait EleTypeContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<EleTypeContextExt<'input>>
{
    ...
    fn DOUBLE(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn FLOAT(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn INT32(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn INT64(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn UINT32(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn UINT64(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn SINT32(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn SINT64(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn FIXED32(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn FIXED64(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn SFIXED32(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn SFIXED64(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn BOOL(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn STRING(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn BYTES(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(BYTES, 0)
    }
    fn messageOrEnumType(&self) -> Option<Rc<MessageOrEnumTypeContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn eleType(&mut self) -> Result<Rc<EleTypeContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> FieldNumberContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<FieldNumberContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            FieldNumberContextExt { ph: PhantomData },
        ))
    }
}

pub trait FieldNumberContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<FieldNumberContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token IntLit
    /// Returns `None` if there is no child corresponding to token IntLit
    fn IntLit(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn fieldNumber(&mut self) -> Result<Rc<FieldNumberContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = FieldNumberContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 40, RULE_fieldNumber);
...
pub trait FieldContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<FieldContextExt<'input>>
{
    fn eleType(&self) -> Option<Rc<EleTypeContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    }
    fn fieldName(&self) -> Option<Rc<FieldNameContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    ...
    fn fieldNumber(&self) -> Option<Rc<FieldNumberContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    ...
    fn REPEATED(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn fieldOptions(&self) -> Option<Rc<FieldOptionsContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
pub type FieldOptionsContext<'input> =
    BaseParserRuleContext<'input, FieldOptionsContextExt<'input>>;
...
impl<'input> FieldOptionsContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<FieldOptionsContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            FieldOptionsContextExt { ph: PhantomData },
        ))
    }
}

pub trait FieldOptionsContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<FieldOptionsContextExt<'input>>
{
    fn fieldOption_all(&self) -> Vec<Rc<FieldOptionContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn fieldOption(&self, i: usize) -> Option<Rc<FieldOptionContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn fieldOptions(&mut self) -> Result<Rc<FieldOptionsContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = FieldOptionsContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 44, RULE_fieldOptions);
...
impl<'input> FieldOptionContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<FieldOptionContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            FieldOptionContextExt { ph: PhantomData },
        ))
    }
}

pub trait FieldOptionContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<FieldOptionContextExt<'input>>
{
    fn optionName(&self) -> Option<Rc<OptionNameContextAll<'input>>>
    where
        Self: Sized,
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn fieldOption(&mut self) -> Result<Rc<FieldOptionContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = FieldOptionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 46, RULE_fieldOption);
...
impl<'input> OneofContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<OneofContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            OneofContextExt { ph: PhantomData },
        ))
    }
}

pub trait OneofContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<OneofContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token ONEOF
    /// Returns `None` if there is no child corresponding to token ONEOF
    fn ONEOF(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(ONEOF, 0)
    }
    fn oneofName(&self) -> Option<Rc<OneofNameContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    ...
    fn oneofField_all(&self) -> Vec<Rc<OneofFieldContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn oneofField(&self, i: usize) -> Option<Rc<OneofFieldContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn oneof(&mut self) -> Result<Rc<OneofContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> OneofFieldContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<OneofFieldContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            OneofFieldContextExt { ph: PhantomData },
        ))
    }
}

pub trait OneofFieldContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<OneofFieldContextExt<'input>>
{
    fn eleType(&self) -> Option<Rc<EleTypeContextAll<'input>>>
    where
        Self: Sized,
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn oneofField(&mut self) -> Result<Rc<OneofFieldContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = OneofFieldContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 50, RULE_oneofField);
...
impl<'input> MapFieldContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<MapFieldContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            MapFieldContextExt { ph: PhantomData },
        ))
    }
}

pub trait MapFieldContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<MapFieldContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token MAP
    /// Returns `None` if there is no child corresponding to token MAP
    fn MAP(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn LCHEVR(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(LCHEVR, 0)
    }
    fn keyType(&self) -> Option<Rc<KeyTypeContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    ...
    fn COMMA(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn RCHEVR(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(RCHEVR, 0)
    }
    fn mapName(&self) -> Option<Rc<MapNameContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn mapField(&mut self) -> Result<Rc<MapFieldContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> KeyTypeContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<KeyTypeContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            KeyTypeContextExt { ph: PhantomData },
        ))
    }
}

pub trait KeyTypeContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<KeyTypeContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token INT32
    /// Returns `None` if there is no child corresponding to token INT32
    fn INT32(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn keyType(&mut self) -> Result<Rc<KeyTypeContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> FullIdentContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<FullIdentContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            FullIdentContextExt { ph: PhantomData },
        ))
    }
}

pub trait FullIdentContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<FullIdentContextExt<'input>>
{
    /// Retrieves all `TerminalNode`s corresponding to token Ident in current rule
    fn Ident_all(&self) -> Vec<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn fullIdent(&mut self) -> Result<Rc<FullIdentContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> MessageNameContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<MessageNameContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            MessageNameContextExt { ph: PhantomData },
        ))
    }
}

pub trait MessageNameContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<MessageNameContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token Ident
    /// Returns `None` if there is no child corresponding to token Ident
    fn Ident(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn messageName(&mut self) -> Result<Rc<MessageNameContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = MessageNameContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 58, RULE_messageName);
...
impl<'input> EnumNameContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<EnumNameContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            EnumNameContextExt { ph: PhantomData },
        ))
    }
}

pub trait EnumNameContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<EnumNameContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token Ident
    /// Returns `None` if there is no child corresponding to token Ident
    fn Ident(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn enumName(&mut self) -> Result<Rc<EnumNameContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
pub type MessageOrEnumNameContext<'input> =
    BaseParserRuleContext<'input, MessageOrEnumNameContextExt<'input>>;
...
impl<'input, 'a> Listenable<dyn Loki_protoListener<'input> + 'a>
    for MessageOrEnumNameContext<'input>
{
    fn enter(&self, listener: &mut (dyn Loki_protoListener<'input> + 'a)) {
        listener.enter_every_rule(self);
...
impl<'input, 'a> Visitable<dyn Loki_protoVisitor<'input> + 'a>
    for MessageOrEnumNameContext<'input>
{
    fn accept(&self, visitor: &mut (dyn Loki_protoVisitor<'input> + 'a)) {
...
impl<'input> MessageOrEnumNameContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<MessageOrEnumNameContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            MessageOrEnumNameContextExt { ph: PhantomData },
        ))
    }
}

pub trait MessageOrEnumNameContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<MessageOrEnumNameContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token Ident
    /// Returns `None` if there is no child corresponding to token Ident
    fn Ident(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn messageOrEnumName(
        &mut self,
    ) -> Result<Rc<MessageOrEnumNameContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx =
            MessageOrEnumNameContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 62, RULE_messageOrEnumName);
...
impl<'input> FieldNameContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<FieldNameContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            FieldNameContextExt { ph: PhantomData },
        ))
    }
}

pub trait FieldNameContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<FieldNameContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token Ident
    /// Returns `None` if there is no child corresponding to token Ident
    fn Ident(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn fieldName(&mut self) -> Result<Rc<FieldNameContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> OneofNameContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<OneofNameContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            OneofNameContextExt { ph: PhantomData },
        ))
    }
}

pub trait OneofNameContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<OneofNameContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token Ident
    /// Returns `None` if there is no child corresponding to token Ident
    fn Ident(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn oneofName(&mut self) -> Result<Rc<OneofNameContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> MapNameContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<MapNameContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            MapNameContextExt { ph: PhantomData },
        ))
    }
}

pub trait MapNameContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<MapNameContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token Ident
    /// Returns `None` if there is no child corresponding to token Ident
    fn Ident(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn mapName(&mut self) -> Result<Rc<MapNameContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> ServiceNameContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<ServiceNameContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            ServiceNameContextExt { ph: PhantomData },
        ))
    }
}

pub trait ServiceNameContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<ServiceNameContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token Ident
    /// Returns `None` if there is no child corresponding to token Ident
    fn Ident(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn serviceName(&mut self) -> Result<Rc<ServiceNameContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = ServiceNameContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 70, RULE_serviceName);
...
impl<'input> RpcNameContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<RpcNameContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            RpcNameContextExt { ph: PhantomData },
        ))
    }
}

pub trait RpcNameContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<RpcNameContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token Ident
    /// Returns `None` if there is no child corresponding to token Ident
    fn Ident(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn rpcName(&mut self) -> Result<Rc<RpcNameContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
impl<'input> MessageTypeContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<MessageTypeContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            MessageTypeContextExt { ph: PhantomData },
        ))
    }
}

pub trait MessageTypeContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<MessageTypeContextExt<'input>>
{
    fn messageName(&self) -> Option<Rc<MessageNameContextAll<'input>>>
    where
        Self: Sized,
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn messageType(&mut self) -> Result<Rc<MessageTypeContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = MessageTypeContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 74, RULE_messageType);
...
pub type MessageOrEnumTypeContext<'input> =
    BaseParserRuleContext<'input, MessageOrEnumTypeContextExt<'input>>;
...
impl<'input, 'a> Listenable<dyn Loki_protoListener<'input> + 'a>
    for MessageOrEnumTypeContext<'input>
{
    fn enter(&self, listener: &mut (dyn Loki_protoListener<'input> + 'a)) {
        listener.enter_every_rule(self);
...
impl<'input> MessageOrEnumTypeContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<MessageOrEnumTypeContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            MessageOrEnumTypeContextExt { ph: PhantomData },
        ))
    }
}

pub trait MessageOrEnumTypeContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<MessageOrEnumTypeContextExt<'input>>
{
    fn messageOrEnumName(&self) -> Option<Rc<MessageOrEnumNameContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn messageOrEnumType(
        &mut self,
    ) -> Result<Rc<MessageOrEnumTypeContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx =
            MessageOrEnumTypeContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 76, RULE_messageOrEnumType);
...
pub type EmptyStatementContext<'input> =
    BaseParserRuleContext<'input, EmptyStatementContextExt<'input>>;
...
impl<'input> EmptyStatementContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn Loki_protoParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<EmptyStatementContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            EmptyStatementContextExt { ph: PhantomData },
        ))
    }
}

pub trait EmptyStatementContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<EmptyStatementContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token SEMI
    /// Returns `None` if there is no child corresponding to token SEMI
    fn SEMI(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn emptyStatement(&mut self) -> Result<Rc<EmptyStatementContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx =
            EmptyStatementContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 78, RULE_emptyStatement);
...
pub trait ConstantContextAttrs<'input>:
    Loki_protoParserContext<'input> + BorrowMut<ConstantContextExt<'input>>
{
    fn fullIdent(&self) -> Option<Rc<FullIdentContextAll<'input>>>
    where
        Self: Sized,
    ...
    fn PLUS(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn FloatLit(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn BoolLit(&self) -> Option<Rc<TerminalNode<'input, Loki_protoParserContextType>>>
    where
        Self: Sized,
    {
